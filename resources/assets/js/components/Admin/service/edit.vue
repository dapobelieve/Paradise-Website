      ...
      <div class="col-xs-12">
        ...
        <div class="widget-box">
          <div class="widget-title">
            ...
            <h5>Edit Service <em v-if="upload.state">{{ upload.progress }}</em></h5>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      submitCourse (){
        ...
        api.post('api/service/edit/'+this.$route.params.id, td, {
          headers: {
    ...
    mounted() {
      this.getProperty(parseInt(this.$route.params.id), 'api/service')
