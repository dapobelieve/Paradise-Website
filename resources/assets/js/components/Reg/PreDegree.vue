      ...
      <div class="container">
        ...
        <div v-if="tab === 2" class="row">
          <div class="col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3">
            <div class="form-group">
              <label for="surname">First Choice Course</label>
            ...
            <div class="form-group">
              <label for="surname">Second Choice Course</label>
        ...
        <div v-if="tab === 6" class="row">
          <div class="col-md-6 col-md-offset-3 col-sm-offset-2">
            ...
            <h3></h3>
            <div class="form-group">
              <label for="surname">School Name</label>
              <input type="text" v-model="form.de_name"  class="form-control" placeholder="School Name">
            </div>
            <div class="form-group">
              <label for="surname">Address</label>
              <input type="text" v-model="form.de_add"  class="form-control" placeholder="School Address">
            </div>
            <div class="form-group">
              <label for="surname">Year joined</label>
              <input type="text" v-model="form.joined"  class="form-control" placeholder="year joined">
            </div>
            <div class="form-group">
              <label for="surname">Year Finished</label>
              <input type="text" v-model="form.finished" required  class="form-control" placeholder="year finished">
            </div>
          </div>
        </div>
    ...
    export default {
        ...
        methods: {
            save () {
                ...
                fd.append('joined', this.form.joined ? this.form.joined : '');
                fd.append('finished', this.form.finished ? this.form.finished : '');
