        ...
        <div class="slider-banner-fullwidth">
            <ul class="slides">
                ...
                <div class="tp-caption sfb fadeout text-center large_white"
                    ...
                    data-speed="500"
                    data-start="1000"
                    data-easing="easeOutQuad"><span class="logo-font">The <span class="text-default">Project</span></span> <br> Next Generation Template
                </div>  
                ...
                <div class="tp-caption sfb fadeout text-center large_dark"
                    ...
                    data-speed="500"
                    data-start="1000"
                    data-easing="easeOutQuad"><span class="logo-font">The <span class="text-default">Project</span></span> <br> Premium Bootstrap Template
                </div>  
